...
export default function OnboardingWizard() {
  ...
  return (
    ...
    <div
      className="w-full max-w-md mx-auto flex flex-col bg-card border border-border rounded-[32px] text-foreground shadow-2xl relative"
    ...
    >
      ...
      {step < 3 && (
        <div className="w-full flex gap-2 pt-6 pb-4 px-8 flex-shrink-0">
          <div className="h-1 flex-1 bg-primary rounded-full transition-all duration-300" />
          <div className={`h-1 flex-1 rounded-full transition-all duration-300 ${step >= 2 ? "bg-primary" : "bg-muted"}`} />
        </div>
      )}
      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        >
          ...
          <h1 className="text-2xl font-semibold mb-3 text-center text-foreground">What should we call your gym?</h1>
          ...
          <div className="w-full mb-8">
            <label className="block text-sm text-muted-foreground mb-2 font-medium">Gym name</label>
            <input
              type="text"
              value={gymName}
              onChange={(e) => setGymName(e.target.value)}
              placeholder="e.g. Iron Pulse Fitness"
              className="w-full bg-muted border border-border rounded-xl px-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors duration-200"
          ...
          <button
            ...
            className="w-full bg-primary text-primary-foreground font-semibold rounded-xl py-4 transition-transform active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100"
          >
            Let&apos;s go
          </button>
        </div>
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-6 pt-4 pb-4">
            <div className="flex flex-col items-center">
              ...
              <h1 className="text-2xl font-semibold mb-3 text-center text-foreground">Set your membership pricing</h1>
              <p className="text-muted-foreground text-center mb-8 text-sm px-4">
              ...
              <div className="w-full space-y-4">
                <div>
                  <label className="block text-sm text-muted-foreground mb-2 font-medium">Monthly price</label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="1,500"
                      className="w-full bg-muted border border-border rounded-xl pl-8 pr-4 py-3 text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary transition-colors duration-200"
                    />
                  </div>
                </div>
                ...
                <button
                  ...
                  className="text-primary text-sm font-medium flex items-center justify-center w-full py-2 hover:opacity-80"
                >
                ...
                <div className={`space-y-4 overflow-hidden transition-all duration-300 ${showExtraDurations ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}>
                  <div>
                    <label className="block text-sm text-muted-foreground mb-2 font-medium">3 months</label>
                    <div className="relative">
                      <span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">₹</span>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-sm text-muted-foreground mb-2 font-medium">6 months</label>
                    <div className="relative">
                      <span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">₹</span>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-sm text-muted-foreground mb-2 font-medium">12 months</label>
                    <div className="relative">
                      <span className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground">₹</span>
                      <input
                        type="text"
          ...
          <div className="flex-shrink-0 px-6 pb-8 pt-2 bg-card">
            <button
              onClick={handleSubmit}
              disabled={!pricing.monthly || loading}
              className="w-full bg-primary text-primary-foreground font-semibold rounded-xl py-4 transition-transform active:scale-[0.98] disabled:opacity-50 disabled:active:scale-100 flex justify-center items-center h-[56px]"
            >
              {loading ? (
