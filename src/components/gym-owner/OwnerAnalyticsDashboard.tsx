    ...
    <div className="space-y-5">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <StatCard
          ...
          value={String(data.summary.pausedMembers)}
        />
        <StatCard
          label="Inactive members"
          value={String(data.summary.inactiveMembers)}
        />
        <StatCard
        ...
        <StatCard
          label="Paid members"
          value={String(data.summary.paidMembers)}
        />
        <StatCard
          label="Unpaid members"
          value={String(data.summary.unpaidMembers)}
        />
        <StatCard
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="rounded-xl border border-border bg-card p-4">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Renewal: {data.retention.renewalRate}% | Churn:{" "}
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          ...
          <p className="mt-1 text-xs text-muted-foreground">
            Success: {data.payments.successRate}% | Failures:{" "}
            {data.payments.failureRate}%
          </p>
          <div className="mt-3 h-[240px]">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="rounded-xl border border-border bg-card p-4">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          Solid line: paid enrollment revenue by month.
        </p>

        <p className="mt-1 text-xs text-muted-foreground">
          Dashed: combined forecast (trend + renewal pipeline).
        </p>
